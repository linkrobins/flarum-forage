...
import { relatedInComposer, relatedUnderDiscussion } from './forum/loadRelated';
...
app.initializers.add('linkrobins/forage', () => {
  ...
  extend('flarum/forum/components/DiscussionPage', 'view', function (this: any, vnode: Mithril.Vnode<any, any>) {
    if (!relatedUnderDiscussion() || this.loading || !this.discussion || !vnode) {
      return;
    }
